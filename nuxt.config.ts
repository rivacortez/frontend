...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        {
          name: "description",
          content: "Control de rentabilidad con IA para tu restaurante",
        },
      ],
      link: [
  ...
  // El wizard de registro corre como SPA para hidratar su progreso desde
  // sessionStorage antes de los guards de página (fix E01-3): bajo SSR el store
  // arrancaba vacío en el servidor y rebotaba al paso 1 en cada recarga.
  routeRules: {
    "/app/**": { ssr: false },
    "/registro/**": { ssr: false },
  },
